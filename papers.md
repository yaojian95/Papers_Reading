...
![suddenly discontinuing the calculation in the integration range](https://www.shimadzu.com/an/sites/shimadzu.com.an/files/d7/ckeditor/an/ftir/support/tips/n9j25k000007q99h-img/n9j25k000008d756.jpg)
![the contributions decrease at a constant rate as the limit is approached](https://www.shimadzu.com/an/sites/shimadzu.com.an/files/d7/ckeditor/an/ftir/support/tips/n9j25k000007q99h-img/n9j25k000008d786.jpg)

    At a glance, it is apparent that the ripples are smaller.  This is because the integration is not suddenly discontinued at the limit. Rather, the contributions decrease at a constant rate as the limit is approached.  However, the central peak is also lower and somewhat wider. This appears as reduced resolution in the actual spectrum.  Applying some type of function to Fourier transform integration to reduce the ripples, as in this example, is called "apodization" and the function is known as an "apodization function." It can be seen from the examples of the box-car waveform and triangular waveform that reducing the ripples implies a compromise between the resolution and peak height. Improving one makes the other worse. Therefore, the apodization function must be selected to suit the intended purpose.
...
Continuity equation(conservation of energy (or, momentum)):
$$\frac{\partial{\rho}}{\partial t} + \nabla \cdot \vec J = 0$$
set $P^0 = \rho, P^{1,2,3} = J^{1,2,3}, x^{\mu} = \{t, x^1,x^2,x^3\}$, we have 
$$\frac{\partial P^{\mu}}{\partial x^{\mu}} = 0.$$
And we can genaralize to add **momentum** component, and to tensorial form
$$\frac{D T^{\mu\nu}}{D x^{\mu}} = \nabla_{\nu} T^{\mu \nu}=0.$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU1NzUyNTIzMCwxNDE2NTc4NTEyLC0yMT
